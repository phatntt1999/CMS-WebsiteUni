		...
		<div id="carouselExampleIndicators" class="carousel slide"
			...
			<div class="carousel-inner" style="text-align: center;">
				<div class="carousel-item active">
					...
					<a
						href="ShowDetailArticleServlet?arId=<%=listArticle.get(listArticle.size() - 2).getid_Articles()%>"
						class="post"><span
						style="font-size: larger; font-weight: bold; padding-top: 20px;">
							<%=listArticle.get(listArticle.size() - 2).getArticleName()%>
					</span></a> <br> <span><%=listArticle.get(listArticle.size() - 2).getDate_upload()%>
				...
				<div class="carousel-item">
					<img src="static/images/post.jpg" class="d-block w-100" alt="...">
					<a
						href="ShowDetailArticleServlet?arId=<%=listArticle.get(listArticle.size() - 3).getid_Articles()%>"
						class="post"><span
						style="font-size: larger; font-weight: bold; padding-top: 20px;">
							<%=listArticle.get(listArticle.size() - 3).getArticleName()%>
					</span></a> <br> <span><%=listArticle.get(listArticle.size() - 3).getDate_upload()%>
				...
				<div class="carousel-item">
					<img src="static/images/post.jpg" class="d-block w-100" alt="...">
					<a
						href="ShowDetailArticleServlet?arId=<%=listArticle.get(listArticle.size() - 4).getid_Articles()%>"
						class="post"><span
						style="font-size: larger; font-weight: bold; padding-top: 20px;">
							<%=listArticle.get(listArticle.size() - 4).getArticleName()%>
					</span></a> <br> <span><%=listArticle.get(listArticle.size() - 4).getDate_upload()%>
